...
public class BoxAdapter extends BaseAdapter {
    ...
    // id по позиции
    // Метод getItemId должен возвращать id элемента. Здесь не заморачиваемся и возвращаем позицию.
    @Override
    ...
    // получаем buttonView, и его состояние (isChecked) находим его позицию(getTag), из позиции получаем товар, и выставляем ему соответствующий атрибут box
